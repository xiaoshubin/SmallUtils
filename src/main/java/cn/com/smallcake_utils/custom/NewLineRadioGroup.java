 ...
 * Created by Small Cake on  2018/5/17 15:32.
 * 可以自动换行的RadioGroup
 */

public class NewLineRadioGroup extends RadioGroup {
    private static final String TAG = "RadioGroupEx";

    public NewLineRadioGroup(Context context) {
        super(context);
    }

    public NewLineRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
